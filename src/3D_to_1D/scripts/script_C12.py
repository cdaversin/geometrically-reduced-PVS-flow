## Run 1D PVS model on C0075 centerline
## To be compared with 3D (C0075) results from "The mechanisms behind perivascular fluid flow"
...
params["dt"] = 0.005
L_PVS = 44e-3 # [mm]
params["coord_factor"] = 1.2/L_PVS #C0075
...
cwd = os.getcwd()
params["case_dir"] = cwd + "/../../C0075/"
params["case_prefix"] = "C0075_clip2_mesh1_0.95_ratio"
# Path to results directory
params["results_dir"] = cwd + "/../../../results/results_C12/"
...
params["inlet_markers"] = [22]
params["outlet_markers"] = [21,23]
...
#compute_1D_avg_from_3D_solution(params["case_dir"], params["case_prefix"], params["results_dir"], params["coord_factor"])
